    ...
    >
      <div className="flex flex-col items-center w-full mt-3">
        <div className="display-flex justify-start w-full mb-6 p-2">
          <a href={`https://explorer.testnet.swisstronik.com/address/${addressFrom}`} target="_blank" rel="noreferrer">
            <p className="text-white text-base">From: {shortenAddress(addressFrom)}</p>
          </a>
          <a href={`https://explorer.testnet.swisstronik.com/address/${addressTo}`} target="_blank" rel="noreferrer">
          ...
          {message && (
            <>
             <br/>
             <p className="text-white text-base">Email: {keyword}</p>
